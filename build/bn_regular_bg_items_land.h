...
#define land_bn_gfxTilesLen 512
extern const bn::tile land_bn_gfxTiles[16];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item land(
            regular_bg_tiles_item(span<const tile>(land_bn_gfxTiles, 16), bpp_mode::BPP_8, compression_type::NONE), 
